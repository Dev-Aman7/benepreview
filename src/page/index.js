...
class Home extends React.Component {
	...
	static getDerivedStateFromProps(nextProps, prevState) {
		if (nextProps.products !== prevState.allProducts) {
			console.log({
			...
			>
				<Carousel>
					<Carousel.Item>
						<div>
							<Banner
								image={process.env.PUBLIC_URL + `/images/Banner-Image-1.png`}
								mobileImage={
									process.env.PUBLIC_URL + `/images/Banner-Image-1.png`
								}
					...
					<Carousel.Item>
						<div>
							<Banner
								...
								mobileImage={`/images/Banner-Image-2.png`}
								versions={["brand-heading"]}
								// heading={<span><span style={{fontSize: "1.3em"}}>bené</span> fits <br />your life</span>}
								heading={parse(bannerTitle)}
								// content={<span>In our own quest to enhance total balance and <br />reduce stress, we set out to understand, what is CBD.</span>}
					...
					<div className="wellness-wrapper">
						...
						<div className="wellness-wrapper__desp">
							...
							<p className="wellness-wrapper__desp--text">
								Today we're confident that were providing you with the highest
								quality CBD you can find. Our product line is a collection, to
								suit a wide range of tastes and needs. We're dedicated to
								helping you get the products that suit you, as well as your
								pets. That's right, we have CBD products for pets too.
							</p>
							...
							<div className="willness-img">
								<img
									className="img-fluid"
									src={`/images/Wellness-Image-1.png`}
								></img>
							</div>
						</div>
					</div>
